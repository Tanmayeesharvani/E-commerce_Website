...
END;
   $ser=$_POST['ser'];
    ...
    $string = "Laptop";
    $substring_index = stripos("Laptop", "$ser");
...
END;
  ...
  $ser=$_POST['ser'];
    ...
    $string = "Laptop";
    $substring_index = stripos("Phone", "$ser");
   if($substring_index !== false) {
echo <<<END
...
$ser=$_POST['ser'];
    ...
    $string = "Laptop";
    $substring_index = stripos("Washing Machine", "$ser");
   if($substring_index !== false) {
echo <<<END
<div class="row">
    <div class = "col-sm-6">
...
$ser=$_POST['ser'];
    ...
    $string = "Laptop";
    $substring_index = stripos("Camera", "$ser");
   if($substring_index !== false) {
echo <<<END
<div class = "col-sm-6">
...
$ser=$_POST['ser'];
    ...
    $string = "Laptop";
    $substring_index = stripos("TV", "$ser");
   if($substring_index !== false) {
echo <<<END
